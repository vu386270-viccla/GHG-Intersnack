...
- Skill uses run a shell command tool → REQUIRED (can execute arbitrary commands)
...
Each eval follows the format defined in `the rune-test skill` → "Skill Behavior Tests" section:
