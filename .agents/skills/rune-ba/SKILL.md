...
Output is a Requirements Document → hand off to the rune-plan skill for implementation planning.
</HARD-GATE>
...
If existing codebase → invoke `the rune-scout skill` for context before proceeding.
