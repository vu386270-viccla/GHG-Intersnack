...
export const comparisonRows: ComparisonRow[] = [
  { site: 'Long An', category: 'Fuel / diesel', appActivity: 1700, appUnit: 'litre', appTco2e: 4.56, appEf: 2.68, appEfUnit: 'kgCO2e/litre', groupActivity: 16932, groupUnit: 'kWh', groupKwhFactor: 9.96, groupKwhFactorUnit: 'kWh/litre', status: 'unit_gap', note: 'Group stores kWh; reverse calculation = 1,700 litre, matching app.' },
  { site: 'Phan Thiet', category: 'Fuel / diesel', appActivity: 1008.19, appUnit: 'litre', appTco2e: 2.7, appEf: 2.68, appEfUnit: 'kgCO2e/litre', groupActivity: 10041.48, groupUnit: 'kWh', groupKwhFactor: 9.96, groupKwhFactorUnit: 'kWh/litre', status: 'unit_gap', note: 'Group reverse calculation = 1,008.18 litre, matching app.' },
  { site: 'Tay Ninh', category: 'Fuel / diesel', appActivity: 14294, appUnit: 'litre', appTco2e: 38.31, appEf: 2.68, appEfUnit: 'kgCO2e/litre', groupActivity: 142368.24, groupUnit: 'kWh', groupKwhFactor: 9.96, groupKwhFactorUnit: 'kWh/litre', status: 'unit_gap', note: 'Stationary fuel matches after kWh / 9.96; fleet diesel differs separately.' },
  { site: 'Tuticorin', category: 'Fuel / diesel', appActivity: 48534, appUnit: 'litre', appTco2e: 130.07, appEf: 2.68, appEfUnit: 'kgCO2e/litre', groupActivity: 483398.64, groupUnit: 'kWh', groupKwhFactor: 9.96, groupKwhFactorUnit: 'kWh/litre', status: 'unit_gap', note: 'Group reverse calculation = 48,534 litre, matching app.' },
  { site: 'Long An', category: 'Wood / boiler', appActivity: 1564.74, appUnit: 'ton', appTco2e: 43.81, appEf: 28, appEfUnit: 'kgCO2e/ton', groupActivity: 7667226, groupUnit: 'kWh', groupKwhFactor: 4.9, groupKwhFactorUnit: 'kWh/kg', groupEf: 0, groupEfUnit: 'kgCO2e/kWh', status: 'unit_gap', note: 'Group reverse calculation = 1,564.74 ton; CO2 factor in workbook is 0/blank.' },
  { site: 'Phan Thiet', category: 'Wood / boiler', appActivity: 1604.13, appUnit: 'ton', appTco2e: 44.92, appEf: 28, appEfUnit: 'kgCO2e/ton', groupActivity: 6416512, groupUnit: 'kWh', groupKwhFactor: 4, groupKwhFactorUnit: 'kWh/kg', groupEf: 0, groupEfUnit: 'kgCO2e/kWh', status: 'unit_gap', note: 'Group uses 4.0 kWh/kg here instead of 4.9; reverse calculation matches app tonnage.' },
  { site: 'Tay Ninh', category: 'Wood / boiler', appActivity: 1886.97, appUnit: 'ton', appTco2e: 52.84, appEf: 28, appEfUnit: 'kgCO2e/ton', groupActivity: 9245908, groupUnit: 'kWh', groupKwhFactor: 4.9, groupKwhFactorUnit: 'kWh/kg', groupEf: 0, groupEfUnit: 'kgCO2e/kWh', status: 'unit_gap', note: 'Group reverse calculation = 1,886.92 ton, near app.' },
  { site: 'Tuticorin', category: 'Biomass / boiler', appActivity: 1366.04, appUnit: 'ton', appTco2e: 47.81, appEf: 35, appEfUnit: 'kgCO2e/ton', groupActivity: 6693596, groupUnit: 'kWh', groupKwhFactor: 4.9, groupKwhFactorUnit: 'kWh/kg', status: 'unit_gap', note: 'Group reverse calculation = 1,366.04 ton, matching app.' },
  { site: 'Tuticorin', category: 'Gas', groupActivity: 34367.2, groupUnit: 'kWh', groupKwhFactor: 13.6, groupKwhFactorUnit: 'kWh/unit', status: 'needs_factor', note: 'Group has gas kWh but CO2 factor is blank; source activity = 2,527 units.' },
  { site: 'HCM Office', category: 'Fuel consumption', groupActivity: 76297.13, groupUnit: 'kWh', groupKwhFactor: 9.96, groupKwhFactorUnit: 'kWh/litre if diesel-equivalent', status: 'missing_app', note: 'Office data exists only in group file; reverse estimate is ~7,660 litre if same 9.96 kWh/litre factor is used.' },
