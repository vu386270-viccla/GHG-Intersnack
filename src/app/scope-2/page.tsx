...
export default function Scope2Page() {
  const scopeData = DEMO_SCOPE_SUMMARIES.find(s => s.scope === 'scope_2')!;
    ...
    <div>
      ...
      <div className="page-header">
        <div className="page-title">
          ...
          Scope 2
          <span className="page-title-accent">Năng lượng mua</span>
        </div>
        <div className="page-subtitle">
          Phát thải gián tiếp từ điện lưới mua — Location-based method
        </div>
      </div>
      ...
      <div className="grid-4 stagger-children mb-xl">
        ...
        <div className="card kpi-card animate-fade-in-up">
          ...
          <div className="kpi-card-label">Điện lưới</div>
        </div>
      </div>

      {/* Grid Emission Factors Management */}
      <div className="grid-2 mb-xl">
        <div className="card animate-fade-in-up">
          <div className="card-header">
            <div className="card-title">🇻🇳 Hệ số lưới điện Việt Nam</div>
            <div className="header-badge">kg CO₂e / kWh</div>
          </div>
          <table className="data-table">
            <thead>
              <tr>
                <th>Năm</th>
                <th style={{ textAlign: 'right' }}>EF (kg CO₂e/kWh)</th>
                <th>Nguồn</th>
              </tr>
            </thead>
            <tbody>
              {vnEFs.map(ef => (
                <tr key={ef.year} style={{ background: ef.year === selectedYear ? 'var(--color-scope-2-light)' : undefined }}>
                  ...
                  <td style={{ textAlign: 'right', fontFamily: 'var(--font-display)', fontSize: '20px', fontWeight: 700 }}>
                    {ef.factor.toFixed(4)}
                  </td>
        ...
        <div className="card animate-fade-in-up">
          <div className="card-header">
            <div className="card-title">🇮🇳 Hệ số lưới điện Ấn Độ</div>
            <div className="header-badge">kg CO₂e / kWh</div>
          </div>
          <table className="data-table">
            <thead>
      ...
      <div className="section mb-xl">
        <div className="section-header">
          <div className="section-title">So sánh nhà máy — Scope 2 (Điện)</div>
        </div>
        <div className="card animate-fade-in-up">
          <BarChart
            data={DEMO_FACTORY_SUMMARIES.map(fs => ({
              ...
              values: [
                { key: 'scope_2', value: fs.scope2, color: scopeColor },
              ],
            }))}
