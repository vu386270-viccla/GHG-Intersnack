...
const EF = {
  ...
  VN_EF: 0.7221,
  INDIA_EF: 0.8928,
  // Wastewater emission factor (kgCO2e/m3) derived from PhanThiet 2025
  WASTEWATER_VN: 0.2315,
  WASTEWATER_IN: 0.2315 // assume same for now
};
...
lines.forEach(line => {
  ...
  const wastewater = parseFloat(cols[4]) || 0; // cubic metres
...
// Print kg (multiply by 1000, rounded to integer)
console.log('\n=== Scope1 (kg) ===');
console.log('Year,PhanThiet,LongAn,TayNinh,Tuticorin,Total_VN,Total_ICC');
years.forEach(y => {
